...
const tutorialSteps = [
    ...
    { selector: '[data-tutorial-id="category"]', title: '4. Categoría de Palabras', content: 'Elige un tema para la palabra secreta. ¡Prueba "Aleatorio" para que las palabras sean únicas y de variados temas!', placement: 'top' as const },
